...
const STEPS = [
  'Basic details (name, category, phone, timings, image)',
  'Location (address, city, area, pincode)',
  'Documents (business proof, identity proof, GST)',
  'Bank details (holder, account, IFSC)',
  'Submit for approval',
];
    ...
    <Screen scroll>
      ...
      <View style={styles.infoCard}>
        <AppText style={styles.descriptionText}>
          Register your shop with complete business details. After Super Admin approval, your shop
          will appear in User-app under the selected category.
        </AppText>
      </View>
