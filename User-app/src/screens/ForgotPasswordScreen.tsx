...
export function ForgotPasswordScreen({ navigation }: Props) {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      await sendOtp(normalizedPhone, 'RESET_PASSWORD');
      navigation.navigate('OtpVerify', { phone: normalizedPhone, mode: 'forgotPassword' });
    } catch (error) {
    ...
    <Screen scroll>
      <View style={styles.centerWrap}>
        <View style={styles.card}>
          ...
          <AppText style={styles.subtitle}>Enter your mobile number to reset password</AppText>
          ...
          <View style={styles.formGroup}>
            ...
            <Pressable style={styles.secondaryAction} onPress={() => navigation.navigate('Login')}>
              <AppText style={styles.secondaryActionText}>Back to Login</AppText>
            </Pressable>
          </View>
        </View>
      </View>
