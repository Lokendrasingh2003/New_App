...
export function SignupScreen({ navigation }: Props) {
  ...
  const canSubmit =
    isNameValid && isPhoneValid && isPasswordStrong && isConfirmValid && agreeTerms && !isSubmitting;
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      await sendOtp(normalizedPhone, 'REGISTER');
          ...
          <View style={styles.formGroup}>
            ...
            <AppInput
              ...
              onChangeText={(value) => {
                ...
                setFieldError(
                  'password',
                  isValidPassword(value) ? undefined : 'Password must be at least 6 characters.',
                );
              }}
              secureTextEntry
